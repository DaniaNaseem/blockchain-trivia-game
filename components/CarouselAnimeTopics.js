...
function Carousel() {
  ...
  async function fetchTopics() {
    try {
      ...
      const animeTopics = data.filter(item => item.category === "Anime and Manga");

      setTopics(animeTopics);
    } catch (error) {
  ...
  return (
    <div className="group relative bg-slate-900">
      <h1 className="text-center pt-8 text-2xl font-bold text-white light:text-white">Anime Topics</h1>
