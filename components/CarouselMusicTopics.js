...
function Carousel() {
  ...
  async function fetchTopics() {
    try {
      ...
      const musicTopics = data.filter(item => item.category === "Music");

      setTopics(musicTopics);
    } catch (error) {
  ...
  return (
    <div className="group relative bg-slate-900">
      <h1 className="text-center pt-8 text-2xl font-bold text-white light:text-white">Music & Bands</h1>
