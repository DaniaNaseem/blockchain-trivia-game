...
function Carousel() {
  ...
  async function fetchTopics() {
    try {
      ...
      const academicTopics = data.filter(item => item.category === "Skills and Academics");
      
      setTopics(academicTopics);
    } catch (error) {
  ...
  return (
    <div className="group relative bg-slate-950">
      <h1 className="text-center pt-8 text-2xl font-bold text-white light:text-white">Academic Topics</h1>
