...
function Carousel() {
  ...
  async function fetchTopics() {
    try {
      ...
      const peopleAndPlacesTopics = data.filter(item => item.category === "Places");
      
      setTopics(peopleAndPlacesTopics);
    } catch (error) {
  ...
  return (
    <div className="group relative bg-slate-950">
      <h1 className="text-center pt-8 text-2xl font-bold text-white light:text-white">People and Places</h1>
